    ...
    <!-- <div class="container">
        <div class="formulario">
            <header class="encabezado">
                <h1 class="headerCotiza">Cotiza tus productos</h1>
            </header>

            <!-- class="formulario-cotizacion" 
            <form id="cotizar-producto" action="../php/procesar-cotizacion.php" method="post">
                <div class="grupo">
                    <!-- Lista selector de producto
                    <label class="labelText" for="producto">Producto:</label>
                ...
                <!-- Lista selector de cantidad 
                <div class="grupo">
                    <label class="labelText" for="cantidad">Cantidad:</label>
                    <select id="cantidad" name="cantidad" onchange="myFunction(this.value)"></select>
                </div>
                <!-- Selector tipo producto -->
    <!-- <fieldset class="grupo" id="tipoProducto" name="tipoProducto">
                    <legend class="tipoProduc">Tipo Producto</legend>
                    <div class="fullGrupo">
                        <div class="grupo">
                            <label>Completo</label>
                            <input type="radio" name="tipo" value="completo" checked>
                        </div>
                        <div class="grupo">
                            <label class="font-bold uppercase mr-2">Basico</label>
                            <input type="radio" name="tipo" value="basico">
                        </div>
                </fieldset> 
                <div class="grupo">
                    <!-- Lista selector de producto 
                    <label class="labelText" for="tipoProducto">Tipo de Producto:</label>
                ...
                <div class="grupo">
                    <button type="submit" class="boton-cotizar">Cotizar Producto</button>
                </div>
            </form>
        </div>
